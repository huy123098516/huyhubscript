...
createButton("Fast Attack", "Farm", UDim2.new(0, 10, 0, 170), Color3.fromRGB(255, 0, 255), function()
...
createButton("Stop Attack", "Farm", UDim2.new(0, 10, 0, 220), Color3.fromRGB(255, 50, 50), function()
...
createButton("Teleport Marine", "Teleport", UDim2.new(0, 10, 0, 170), Color3.fromRGB(0, 120, 255), function()
	local island = game.Workspace:FindFirstChild("MarineBase")
	if island and island:FindFirstChild("SpawnPoint") then
		player.Character.HumanoidRootPart.CFrame = island.SpawnPoint.CFrame + Vector3.new(0, 5, 0)
	end
end)
...
createButton("Increase Speed", "Misc", UDim2.new(0, 10, 0, 170), Color3.fromRGB(255, 255, 0), function()
	player.Character.Humanoid.WalkSpeed = 100
end)

createButton("Reset Speed", "Misc", UDim2.new(0, 10, 0, 220), Color3.fromRGB(255, 255, 0), function()
	player.Character.Humanoid.WalkSpeed = 16
end)

createButton("Auto Buy Fruit", "Misc", UDim2.new(0, 10, 0, 270), Color3.fromRGB(160, 0, 255), function()
	print("Auto Buy Fruit Activated")
end)
